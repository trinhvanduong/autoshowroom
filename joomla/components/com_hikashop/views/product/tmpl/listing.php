        ...
        if ($this->params->get('show_image') && !empty($this->element->file_path)) {
            ...
            if (JFile::exists($this->image->getPath($this->element->file_path, false))) {
                ...
                <img src="<?php echo $this->image->getPath($this->element->file_path); ?>"
                     ...
                     title="<?php echo $this->escape(@$this->element->file_description); ?>"
        ...
        <div class="hikashop_products_listing">
            ...
            if (JRequest::getVar('hikashop_front_end_main', 0) && JRequest::getVar('task') == 'listing' && $this->params->get('show_compare')) {
                ...
                <div id="hikashop_compare_zone" class="hikashop_compare_zone">
                    <a class="<?php echo $css_button . ' ' . $css_button_compare; ?>" id="hikashop_compare_button"
                       style="display:none;" href="#"
                       data-compare-href="<?php echo hikashop_completeLink('product&task=compare' . $this->itemid, false, true); ?>"
                       onclick="if(window.hikashop.compareProducts) { return window.hikashop.compareProducts(this); }"><span><?php

    ...
    jQuery.plusGallery = function (el, options) {
            ...
            if (displayAlbum) {
                ...
                if (pg.type == 'local') {
                    jQuery('#pgalbums').append(
                        '<li class="pgalbumthumb pgthumb mirror">' +
                    ...
                    jQuery(lmnt).find('#pgalbums').append(
                        '<li class="pgalbumthumb pgamirror">' +
            ...
            jQuery.each(objPath, function (i, obj) {
                ...
                if (i < photo_limit) {
                    ...
                    if (obj_click) {
                        ...
                        jQuery(lmnt.selector + ' #pgthumbs').append('<li class="pgthumb mirror">' +
                            '<div class="view second-effect"><div class="front"> ' +
                            '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '</div><div class="back">' +
                            '<a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
        ...
        jQuery.fn.tz_init = function (columns) {
            ...
            if (columns.heightItem) {
                TzTemplateResizeImage(jQuery('.mirror'));
            }
        };

    ...
    jQuery.plusGallery = function (el, options) {
            ...
            if (displayAlbum) {
                ...
                if (pg.type == 'local') {
                    jQuery('#pgalbums').append(
                        '<li class="pgalbumthumb pgthumb pinme">' +
                    ...
                    jQuery(lmnt).find('#pgalbums').append(
                        '<li class="pgalbumthumb pgapinme">' +
                ...
                if (i < photo_limit) {
                    ...
                    if (obj_click) {
                        jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb pinme">' +
                            '<div class="effect-pinme">' +
                            '<div class="image"><img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="image" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '<div class="folio-btn"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"> </a>' +
                            '</div></div>' +
                            '<div class="tz_info"><div class="ming-info"> ' +
                            '<h3>' + imgTitle + '</h3>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                        ...
                        jQuery(lmnt.selector + ' #pgthumbs').append('<li class="pgthumb pinme">' +
                            '<div class="effect-pinme">' +
                            '<div class="image">' +
                            '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="image" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '<div class="folio-btn">' +
                            '<a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"> </a>' +
                            '</div></div>' +
                            '<div class="tz_info"><div class="ming-info"> ' +
                            '<h3>' + imgTitle + '</h3>' +
                            '</div>' +
        ...
        jQuery.fn.slideFade = function (speed, callback, columns) {
            ...
            jQuery('' + album_class + '').animate({
                ...
                function () {
                    ...
                    callBack.call(this);
                    jQuery('.effect-pinme').each(function () {
        ...
        jQuery.fn.tz_init = function (columns) {
            ...
            if (columns.heightItem) {
                TzTemplateResizeImage(jQuery('.pinme'));
            }
        };

    ...
    jQuery.plusGallery = function (el, options) {
            ...
            if (displayAlbum) {
                ...
                if (pg.type == 'local') {
                    jQuery('#pgalbums').append(
                        '<li class="pgalbumthumb pgthumb zumion">' +
                    ...
                    jQuery(lmnt).find('#pgalbums').append(
                        '<li class="pgalbumthumb pgazumion">' +
            ...
            jQuery.each(objPath, function (i, obj) {
                ...
                if (i < photo_limit) {
                    ...
                    if (obj_click) {
                        ...
                        jQuery(lmnt.selector + ' #pgthumbs').append('<li class="pgthumb zumion">' +
                            '<div class="effect-zumion">' +
                            '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '<div class="tz-info"><div class="zumion_info">' +
                            '<h2>' + imgTitle + '</h2>' +
        ...
        jQuery.fn.slideFade = function (speed, callback, columns) {
            ...
            jQuery('' + album_class + '').animate({
                ...
                function () {
                    ...
                    callBack.call(this);
                    jQuery('.effect-zumion').each(function () {
        ...
        jQuery.fn.tz_init = function (columns) {
            ...
            if (columns.heightItem) {
                TzTemplateResizeImage(jQuery('.zumion'));
            }
        };

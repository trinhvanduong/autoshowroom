    ...
    jQuery.plusGallery = function (el, options) {
                ...
                if (i < photo_limit) {
                    ...
                    if (obj_click) {
                        jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb everline">' +
                            '<div class="effect-everline">' +
                            '<div class="image"><img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '<div class="everline-btn"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"> </a>' +
                            '</div></div>' +
                            '<div class="tz_info"><div class="ming-info"> ' +
                            '<h3 class="title">' + imgTitle + '</h3>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</li>');
                    } else {
                        jQuery(lmnt.selector + ' #pgthumbs').append('<li class="pgthumb everline">' +
                            '<div class="effect-everline">' +
                            '<div class="image"><img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '<div class="everline-btn"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"> </a>' +
                            '</div></div>' +
        ...
        jQuery.fn.slideFade = function (speed, callback, columns) {
            ...
            jQuery('' + album_class + '').animate({
                ...
                function () {
                    ...
                    callBack.call(this);
                    jQuery('.effect-everline').each(function () {
        ...
        jQuery.fn.tz_init = function (columns) {
            ...
            if (columns.heightItem) {
                TzTemplateResizeImage(jQuery('.everline .image'));
            }
        };

...
(function (jQuery) {
    jQuery.plusGallery = function (el, options) {
            ...
            if (displayAlbum) {
                ...
                if (pg.type == 'local') {
                    jQuery('#pgalbums').append(
                        '<li class="pgalbumthumb pgthumb lily">' +
            ...
            jQuery.each(objPath, function (i, obj) {
                ...
                if (i < photo_limit) {
                    ...
                    if (obj_click) {
                        ...
                        jQuery(lmnt.selector + ' #pgthumbs').append('<li class="pgthumb lily">' +
                            '<div class="effect-lily"  data-sr="enter top over 3s wait 0.5s">' +
                            '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '<figcaption>' +
                            '<div>' +
                            '<h2>' + imgTitle + '</h2>' +
        ...
        jQuery.fn.tz_init = function (columns) {
            ...
            //    TzTemplateResizeImage(jQuery('.lily'));
            //}
        };

    ...
    jQuery.plusGallery = function (el, options) {
            ...
            if (displayAlbum) {
                ...
                if (pg.type == 'local') {
                    jQuery('#pgalbums').append(
                        '<li class="pgalbumthumb pgthumb ming">' +
            ...
            jQuery.each(objPath, function (i, obj) {
                ...
                if (i < photo_limit) {
                    ...
                    if (obj_click) {
                        ...
                        jQuery(lmnt.selector + ' #pgthumbs').append('<li class="pgthumb ming">' +
                            '<div class="effect-ming">' +
                            '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                            '<div><div class="ming-info"> ' +
                            '<a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"> ' + imgTitle + '</a>' +
        ...
        jQuery.fn.tz_init = function (columns) {
            ...
            if (columns.heightItem) {
                TzTemplateResizeImage(jQuery('.ming'));
            }
        };

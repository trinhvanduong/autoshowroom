...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_ming.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/ming.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.ming  {
          height:' . $height_item . 'px;
    }
    body #plusgallery' . $module->id . ' li.ming.item_height2  {
...
$doc->addStyleDeclaration('
  ...
  body #plusgallery' . $module->id . ' .pgthumb .effect-ming{
          margin: ' . $tz_padding . ';
    }

...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_simple.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/simple.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.simple .effect3 {
...
$doc->addStyleDeclaration('
    ...
    body #plusgallery' . $module->id . ' .pgthumb .simple-overlay{
        margin: ' . $tz_padding . ';

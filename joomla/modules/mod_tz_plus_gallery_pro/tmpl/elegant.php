...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_elegant.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/elegant.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.elegant .effect3 {
...
if ($tz_color_box &&  $tz_color_box != 'rgba(0, 0, 0, 0)') {
    $color .= '
        #Mod' . $module->id . ' .elegant .elegant-info a:hover{
            color: ' . $tz_color_box . '
        }

...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_coffee.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/coffee.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.coffee .effect3{
          height:' . $height_item . 'px;
    }
    body #plusgallery' . $module->id . ' li.coffee.item_height2 .effect3 {

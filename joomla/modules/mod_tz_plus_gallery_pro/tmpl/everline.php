...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_everline.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/everline.css');
...
$doc->addStyleDeclaration('
    ...
    body #plusgallery' . $module->id . ' .pgalbumthumb {
     ...
     body #plusgallery' . $module->id . ' .pgthumb .effect-everline{
          margin: ' . $tz_padding . ';
    }
    body #plusgallery' . $module->id . ' li.everline .image {

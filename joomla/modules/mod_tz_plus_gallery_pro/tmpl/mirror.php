...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_mirror.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/mirror.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.mirror .second-effect {
...
html { overflow-y: scroll; }
    ...
    body #plusgallery' . $module->id . ' .pgthumb .second-effect{
          margin: ' . $tz_padding . ';
    }

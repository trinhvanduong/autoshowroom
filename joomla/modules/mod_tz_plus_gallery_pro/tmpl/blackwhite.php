...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_black_white.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/black_white.css');
...
if ($height_item) {
    $style = '
        body #plusgallery' . $module->id . ' .black_white .effect3{

...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_lania.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/lania.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.lania .effect3 {
          height:' . $height_item . 'px;
    }
    body #plusgallery' . $module->id . ' li.lania.item_height2 .effect3 {

...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_folio.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/folio.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.folio .image {
          height:' . $height_item . 'px;
    }
    body #plusgallery' . $module->id . ' li.folio.item_height2 .image {
...
html { overflow-y: scroll; }
 ...
 body #plusgallery' . $module->id . ' .pgthumb .effect-folio{
          margin: ' . $tz_padding . ';
    }

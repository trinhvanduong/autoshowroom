...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_pinme.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/pinme.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.pinme .image {
          height:' . $height_item . 'px;
    }
    body #plusgallery' . $module->id . ' li.pinme.item_height2 .image {
          height:' . ($height_item * 2) . 'px;
    }
    ';
}
...
html { overflow-y: scroll; }
    body #plusgallery' . $module->id . ' .pgthumb {
     ...
     body #plusgallery' . $module->id . ' .pgthumb .effect-pinme{
          margin: ' . $tz_padding . ';
    }

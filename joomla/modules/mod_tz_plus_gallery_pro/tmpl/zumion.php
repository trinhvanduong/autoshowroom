...
$doc->addScript('modules/mod_tz_plus_gallery_pro/js/plusgallery_zumion.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery_pro/css/zumion.css');
...
if ($height_item) {
    $style = '
    body #plusgallery' . $module->id . ' li.zumion {
          height:' . $height_item . 'px;
    }
    body #plusgallery' . $module->id . ' li.zumion.item_height2 {
...
$doc->addStyleDeclaration('
  ...
  body #plusgallery' . $module->id . ' .pgthumb .effect-bubba{
          margin: ' . $tz_padding . ';
    }

...
class JFormFieldTZColor extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        if (!self::$initialised)
        {
            JFactory::getDocument() -> addStyleSheet(JUri::root().'/modules/mod_tz_plus_gallery_pro/admin/formfields/css/spectrum.css');
            JFactory::getDocument() -> addScript(JUri::root().'/modules/mod_tz_plus_gallery_pro/admin/formfields/js/spectrum.js');

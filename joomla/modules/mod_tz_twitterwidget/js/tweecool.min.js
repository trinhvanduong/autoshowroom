...
!function (t) {
    t.fn.extend({
        tweecool: function (e) {
            function a(t) {
                var e = new Date, a = Date.parse(e), i = 1e3 * t, r = (a - i) / 1e3, o = 1, n = 60, s = 3600, _ = 86400, l = 604800, c = 2592e3, u = 31536e3;
            ...
            return this.each(function () {
                var i, r, o, n, s, _ = e, l = t(this), c = t("<ul>").appendTo(l), u = /(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, w = /@+(\w+)/gi, h = /#+(\w+)/gi;

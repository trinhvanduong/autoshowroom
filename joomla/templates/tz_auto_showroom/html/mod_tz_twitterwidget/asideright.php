...
<div id="TzMod<?php echo $modID; ?>" class="tz-twitter">
...
<!--                <div class="tztwd">-->
                                ...
                                <a href="https://twitter.com/<?php echo $data->tweets[0]->screenName; ?>"
                                   target="_blank">
                                    <img src="<?php echo $data->tweets[0]->profileImage; ?>" class="tztwd-avatar"/>
                                                        <span class="tztwd-display-name">
                    <?php echo $data->tweets[0]->displayName; ?>
                                                        </span>
                    ...
                    <?php foreach ($data->tweets as $key => $tweet): ?>
                        <div class="tztwd-tweet-container">
                            <?php if ($params->get('avatars', 1)): ?>
                                <div class="tz-avata-info">
                                    <a href="https://twitter.com/intent/user?screen_name=<?php echo $tweet->screenName; ?>"
                                       target="_blank">
                                        <img src="<?php echo $tweet->profileImage; ?>" class="tztwd-avatar" alt=""/>
                                    </a>
                                </div>
                            <?php endif; ?>

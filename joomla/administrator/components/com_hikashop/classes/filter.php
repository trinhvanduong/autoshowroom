...
class hikashopFilterTypeClass extends hikashopClass {
	...
	function getDeleteButton($filter, $divName, $val, $html, $br, $onlyButton=false, $id=''){
		...
		if($onlyButton){
			...
			return '<a href="#" style="cursor:pointer; text-decoration:none" onclick="document.getElementById(\''.$id.'\').value=\' \'; '.$submitOnClick.'return false;" title="'.JText::_('REMOVE_THIS_SELECTION').'"><img src="'.HIKASHOP_IMAGES.'delete2.png" /></a>';
		}
		...
		$html.='  <a href="#" style="cursor:pointer; text-decoration:none" onclick="document.getElementById(\'filter_'.$filter->filter_namekey.'_'.$divName.'\').value=\' \'; '.$submitOnClick.'return false;" title="'.JText::_('REMOVE_THIS_SELECTION').'"><img src="'.HIKASHOP_IMAGES.'delete2.png" /></a><br/>';
		return $html;
	}
